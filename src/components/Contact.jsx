...
const Contact = () => {
  ...
  return (
    ...
    >
      <motion.div
        className="flex-1 flex flex-col gap-4 items-start justify-start"
        variants={variants}
      >
        <motion.h1 className="text-[90px] leading-tight" variants={variants}>
          Lets work <br /> together
        </motion.h1>
        <motion.div className="item" variants={variants}>
          <h2 className="text-xl">Mail</h2>
          <span className="text-sm">fghalandarii@gmail.com</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
      ...
      >
        ...
        >
          <svg height="450px" width="450px" viewBox="0 0 473.806 473.806">
            <motion.path
              strokeWidth={2}
        ...
        >
          <input
            className="p-3 border-[1px] border-solid border-[#9be76e] rounded-md bg-transparent text-white"
            required
            type="text"
            placeholder="Name"
            name="name"
          ...
          />
          <button
            className="p-2 w-[200px] border-[1px] rounded-md border-[#9be76e] text-[#9be76e] hover:bg-[#9be76e] hover:text-[#1a1a2e] transition duration-300 ease-in-out"
            type="submit"
          >
            Send
          </button>
